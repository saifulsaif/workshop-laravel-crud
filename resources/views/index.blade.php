...
<div class="container-fluid">
 ...
 <div class="form-group">
   ...
   <input type="text" name="permanent_address" class="form-control" id="inputAddress2" placeholder="Apartment, studio, or floor">
 </div>
 <div class="form-group">
    ...
    <tr>
      ...
      <td>
       <a href="{{ url('edit/'.$row->id)}}"> <button class="from-control btn btn-primary">Edit</button></a>
        <a  class="from-control btn btn-danger" href="{{ url('delete/'.$row->id)}}"> Delete</a>
      </td>
